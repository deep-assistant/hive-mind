...
// Test cases
const testCases = [
  { input: 'haiku', expected: 'claude-haiku-4-5-20250514', description: 'haiku alias' },
  ...
  { input: 'claude-haiku-4-5-20250514', expected: 'claude-haiku-4-5-20250514', description: 'full haiku model ID' },
