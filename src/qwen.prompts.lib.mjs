/**
 * Qwen prompts module
 * Handles building prompts for Qwen commands
 */
...
/**
 * Build the system prompt for Qwen - adapted for Qwen's capabilities
...
export const buildSystemPrompt = (params) => {
  ...
  return `You are AI issue solver using Qwen.${thinkLine}
