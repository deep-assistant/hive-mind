/**
 * Copilot prompts module
 * Handles building prompts for Copilot commands
 */

/**
 * Build the user prompt for Copilot
...
/**
 * Build the system prompt for Copilot - adapted for Copilot's capabilities
 * This will be written to AGENTS.md as custom instructions
...
export const buildSystemPrompt = (params) => {
  ...
  return `You are AI issue solver using GitHub Copilot.${thinkLine}
